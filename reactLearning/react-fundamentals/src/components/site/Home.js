    ...
    return (
        <div className="main">
            <div className="mainDiv">
                ...
                <p>
                    This app is intended to be a starter/tutorial for your upcoming
                    project and a learning sandbox for you in months and years to come
                    should you contine to develop software with React. In this 
                ...
                <ul>
                    ...
                    <li>This app simply scratches the sfurace on what is possible with React</li>
                    <li>We have tried to collect the very best resources for this app, and we have cite those<Link to="/Resources">here</Link>.</li>
                    <li>
