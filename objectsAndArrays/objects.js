...
console.log('Episode:', netflix.season1.seasonInfo.episodeInfo[3].episode);
...
console.log(Object.keys(spaceJam.toonSquad.human)); // String of the index numbers of that string value

console.log(Object.values(spaceJam.toonSquad.rabbit1));
...
/*
    ...
    - using object bracket notation can be handy if we want to store a key in avariable and then use that variable to parse through an object
...
console.log(baking[garden['vegetable']]);// here we are saying the same thing as we did above, we are passing information from our object. garden['vegetable'] is the same as 'zucchini up above
